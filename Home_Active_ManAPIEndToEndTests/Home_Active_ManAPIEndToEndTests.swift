//
//  Home_Active_ManAPIEndToEndTests.swift
//  Home_Active_ManAPIEndToEndTests
//
//  Created by Josef Santamaria on 2020-12-19.
//
...
class Home_Active_ManAPIEndToEndTests: XCTestCase {
    ...
    private func getFeedResult(file: StaticString = #filePath, line: UInt = #line) -> LoadExerciseResult? {
        ...
        var receivedResult: LoadExerciseResult?
